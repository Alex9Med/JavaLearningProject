...
public class GitWorkFlow {
    public static void main(String[] args) {
        ...
        String step10 = "Execute a pull request from Origin/New_Branch_Name into master";
        ...
        String step15 = "Perform a git commit ammend to change the latest executed commit by adding your requested changes";
